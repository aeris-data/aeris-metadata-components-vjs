...
<template>
<span class="aeris-metadata-modifications-host" v-show="visible">
<div class="component-container">
      ...
      <main>
       <span  v-for="modification in modifications">
    	 ...
    	 return
          ...
          for (var i = 0; i< modifications.length;i++) {
        	  ...
        	  if (modification.author) {
        		  ...
        		  this.$http.get(url)
        		  .then((response)=>{this.handleSuccess(response, aux)},(response)=>{this.handleError(response)});
        	  }
          }
       }
       else {
